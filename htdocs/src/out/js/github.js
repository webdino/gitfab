...
require(["jQuery","common","itemlist","gridlayout","item","slide","taglist","lib/showdown","lib/base64"],
	 function($,common,itemlist,gridlayout,item,slide,taglist,showdown,base64){
});
